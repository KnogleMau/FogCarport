...
public class CustomerMapper {
    ...
    public static void customerMapper( String firstname, String lastname, String adress, String zipcode, String city, String phonenumber, String email, ConnectionPool connectionPool) throws DatabaseException {
        int customerId;
...
// meget i tvivl om, hvad fejlkoden bør være her
    ...
    public static int getCustomerId(String lastname, String email, String phonenumber, ConnectionPool connectionPool) throws DatabaseException {
        int customerId = 0;
        String sql = "select customer_id from customer_information where last_name = ? and email = ? and phone_number = ?";
